...
class SwinTransformer_Haar(BaseModule):
    ...
    def __init__(self,
        ...
        # haar
        self.haar = DWTForward(J=1, wave='haar', mode='zero')
        self.dhps = ModuleList()
        for i in out_indices:
            dhp = ConvBNReLU(self.num_features[i], 9, kernel_size=1, stride=1)
            self.dhps.append(dhp)
